...
const profileFacts = [
  ...
  {
    label: "Blog",
    value: "velog.io/@psdkey/posts",
    href: "https://velog.io/@psdkey/posts",
  },
];
      ...
      <div id="top" className={styles.resumeContainer}>
        <section className={styles.resumeHero}>
          <div className={styles.resumeHeroCopy}>
            ...
            <p className={styles.resumeHeroDescription}>
              ...
              Angular 기반 서비스에서 UI/UX 개선, 성능 최적화, 공통 컴포넌트
              설계, 운영 이슈 대응을 꾸준히 맡아왔습니다.
            </p>
        ...
        <section id="about" className={styles.resumeSection}>
          ...
          <p className={styles.resumeSectionDescription}>
            어느 환경에서도 빠르게 적응하며, 사용자의 need를 넘어 want까지
            고려하는 방향으로 화면을 설계해왔습니다. 서비스 페이지부터 관리자
            화면, 인프라 관리 UI까지 다양한 맥락에서 읽기 쉬운 구조와 안정적인
            사용 흐름을 만드는 데 집중해왔습니다.
          </p>
        </section>
